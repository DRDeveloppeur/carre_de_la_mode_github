...
require __DIR__.'/ContainerWUrmpia/App_KernelDevDebugContainer.php';
require __DIR__.'/ContainerWUrmpia/EntityManager_9a5be93.php';
require __DIR__.'/ContainerWUrmpia/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/ContainerWUrmpia/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/ContainerWUrmpia/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/ContainerWUrmpia/getVichUploader_UploadHandlerService.php';
require __DIR__.'/ContainerWUrmpia/getVichUploader_Listener_Upload_PicturesService.php';
require __DIR__.'/ContainerWUrmpia/getVichUploader_Listener_Remove_PicturesService.php';
require __DIR__.'/ContainerWUrmpia/getVichUploader_Listener_Clean_PicturesService.php';
require __DIR__.'/ContainerWUrmpia/getVichUploader_Form_Type_ImageService.php';
require __DIR__.'/ContainerWUrmpia/getVichUploader_Form_Type_FileService.php';
require __DIR__.'/ContainerWUrmpia/getVichUploader_DownloadHandlerService.php';
require __DIR__.'/ContainerWUrmpia/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerWUrmpia/getValidator_ExpressionService.php';
require __DIR__.'/ContainerWUrmpia/getValidator_EmailService.php';
require __DIR__.'/ContainerWUrmpia/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerWUrmpia/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerWUrmpia/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerWUrmpia/getTwig_Mailer_MessageListenerService.php';
require __DIR__.'/ContainerWUrmpia/getTwig_Form_RendererService.php';
require __DIR__.'/ContainerWUrmpia/getTranslation_Loader_YmlService.php';
require __DIR__.'/ContainerWUrmpia/getTranslation_Loader_XliffService.php';
require __DIR__.'/ContainerWUrmpia/getTranslation_Loader_ResService.php';
require __DIR__.'/ContainerWUrmpia/getTranslation_Loader_QtService.php';
require __DIR__.'/ContainerWUrmpia/getTranslation_Loader_PoService.php';
require __DIR__.'/ContainerWUrmpia/getTranslation_Loader_PhpService.php';
require __DIR__.'/ContainerWUrmpia/getTranslation_Loader_MoService.php';
require __DIR__.'/ContainerWUrmpia/getTranslation_Loader_JsonService.php';
require __DIR__.'/ContainerWUrmpia/getTranslation_Loader_IniService.php';
require __DIR__.'/ContainerWUrmpia/getTranslation_Loader_DatService.php';
require __DIR__.'/ContainerWUrmpia/getTranslation_Loader_CsvService.php';
require __DIR__.'/ContainerWUrmpia/getSessionService.php';
require __DIR__.'/ContainerWUrmpia/getServicesResetterService.php';
require __DIR__.'/ContainerWUrmpia/getSerializer_Mapping_CacheClassMetadataFactoryService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_User_Provider_Concrete_UserProviderService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_Logout_Listener_Default_MainService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_HttpUtilsService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_Authenticator_Guard_Main_0Service.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_AuthenticationUtilsService.php';
require __DIR__.'/ContainerWUrmpia/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerWUrmpia/getSecrets_VaultService.php';
require __DIR__.'/ContainerWUrmpia/getRouting_LoaderService.php';
require __DIR__.'/ContainerWUrmpia/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerWUrmpia/getPropertyAccessorService.php';
require __DIR__.'/ContainerWUrmpia/getMimeTypesService.php';
require __DIR__.'/ContainerWUrmpia/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerWUrmpia/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/ContainerWUrmpia/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/ContainerWUrmpia/getForm_TypeExtension_Upload_ValidatorService.php';
require __DIR__.'/ContainerWUrmpia/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/ContainerWUrmpia/getForm_TypeExtension_Form_TransformationFailureHandlingService.php';
require __DIR__.'/ContainerWUrmpia/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/ContainerWUrmpia/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/ContainerWUrmpia/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/ContainerWUrmpia/getForm_Type_FormService.php';
require __DIR__.'/ContainerWUrmpia/getForm_Type_EntityService.php';
require __DIR__.'/ContainerWUrmpia/getForm_Type_ColorService.php';
require __DIR__.'/ContainerWUrmpia/getForm_Type_ChoiceService.php';
require __DIR__.'/ContainerWUrmpia/getForm_ServerParamsService.php';
require __DIR__.'/ContainerWUrmpia/getForm_RegistryService.php';
require __DIR__.'/ContainerWUrmpia/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/ContainerWUrmpia/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/ContainerWUrmpia/getErrorControllerService.php';
require __DIR__.'/ContainerWUrmpia/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerWUrmpia/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerWUrmpia/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerWUrmpia/getDoctrine_Orm_Listeners_PdoCacheAdapterDoctrineSchemaSubscriberService.php';
require __DIR__.'/ContainerWUrmpia/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaSubscriberService.php';
require __DIR__.'/ContainerWUrmpia/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerWUrmpia/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerWUrmpia/getDoctrine_Migrations_ContainerAwareMigrationsFactoryService.php';
require __DIR__.'/ContainerWUrmpia/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerWUrmpia/getDebug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerWUrmpia/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerWUrmpia/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/ContainerWUrmpia/getSecurityVoterService.php';
require __DIR__.'/ContainerWUrmpia/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/ContainerWUrmpia/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/ContainerWUrmpia/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerWUrmpia/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerWUrmpia/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerWUrmpia/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerWUrmpia/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerWUrmpia/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerWUrmpia/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerWUrmpia/getBatchActionDtoResolverService.php';
require __DIR__.'/ContainerWUrmpia/getAdminContextResolverService.php';
require __DIR__.'/ContainerWUrmpia/getDataCollector_Request_SessionCollectorService.php';
require __DIR__.'/ContainerWUrmpia/getContainer_GetenvService.php';
require __DIR__.'/ContainerWUrmpia/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerWUrmpia/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerWUrmpia/getCache_SystemClearerService.php';
require __DIR__.'/ContainerWUrmpia/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerWUrmpia/getCache_AppClearerService.php';
require __DIR__.'/ContainerWUrmpia/getTransliteratorService.php';
require __DIR__.'/ContainerWUrmpia/getUniqidNamerService.php';
require __DIR__.'/ContainerWUrmpia/getSubdirDirectoryNamerService.php';
require __DIR__.'/ContainerWUrmpia/getSmartUniqueNamerService.php';
require __DIR__.'/ContainerWUrmpia/getPropertyNamerService.php';
require __DIR__.'/ContainerWUrmpia/getPropertyDirectoryNamerService.php';
require __DIR__.'/ContainerWUrmpia/getOrignameNamer_PicturesService.php';
require __DIR__.'/ContainerWUrmpia/getOrignameNamerService.php';
require __DIR__.'/ContainerWUrmpia/getHashNamerService.php';
require __DIR__.'/ContainerWUrmpia/getCurrentDateTimeDirectoryNamerService.php';
require __DIR__.'/ContainerWUrmpia/getBase64NamerService.php';
require __DIR__.'/ContainerWUrmpia/getTemplateControllerService.php';
require __DIR__.'/ContainerWUrmpia/getRedirectControllerService.php';
require __DIR__.'/ContainerWUrmpia/getFieldProviderService.php';
require __DIR__.'/ContainerWUrmpia/getEntityUpdaterService.php';
require __DIR__.'/ContainerWUrmpia/getEntityRepositoryService.php';
require __DIR__.'/ContainerWUrmpia/getFiltersFormTypeService.php';
require __DIR__.'/ContainerWUrmpia/getFileUploadTypeService.php';
require __DIR__.'/ContainerWUrmpia/getCrudFormTypeService.php';
require __DIR__.'/ContainerWUrmpia/getEaCrudFormTypeExtensionService.php';
require __DIR__.'/ContainerWUrmpia/getSlugConfiguratorService.php';
require __DIR__.'/ContainerWUrmpia/getNumberConfiguratorService.php';
require __DIR__.'/ContainerWUrmpia/getMoneyConfiguratorService.php';
require __DIR__.'/ContainerWUrmpia/getDateTimeConfiguratorService.php';
require __DIR__.'/ContainerWUrmpia/getCountryConfiguratorService.php';
require __DIR__.'/ContainerWUrmpia/getCommonPreConfiguratorService.php';
require __DIR__.'/ContainerWUrmpia/getCommonPostConfiguratorService.php';
require __DIR__.'/ContainerWUrmpia/getChoiceConfiguratorService.php';
require __DIR__.'/ContainerWUrmpia/getBooleanConfiguratorService.php';
require __DIR__.'/ContainerWUrmpia/getAssociationConfiguratorService.php';
require __DIR__.'/ContainerWUrmpia/getPaginatorFactoryService.php';
require __DIR__.'/ContainerWUrmpia/getFormFactoryService.php';
require __DIR__.'/ContainerWUrmpia/getFilterFactoryService.php';
require __DIR__.'/ContainerWUrmpia/getExceptionListenerService.php';
require __DIR__.'/ContainerWUrmpia/getCrudResponseListenerService.php';
require __DIR__.'/ContainerWUrmpia/getUserRepositoryService.php';
require __DIR__.'/ContainerWUrmpia/getTagRepositoryService.php';
require __DIR__.'/ContainerWUrmpia/getSubCategoryRepositoryService.php';
require __DIR__.'/ContainerWUrmpia/getStockRepositoryService.php';
require __DIR__.'/ContainerWUrmpia/getSizeRepositoryService.php';
require __DIR__.'/ContainerWUrmpia/getProductRepositoryService.php';
require __DIR__.'/ContainerWUrmpia/getProductDetailsRepositoryService.php';
require __DIR__.'/ContainerWUrmpia/getPictureRepositoryService.php';
require __DIR__.'/ContainerWUrmpia/getMarqueRepositoryService.php';
require __DIR__.'/ContainerWUrmpia/getCategoryRepositoryService.php';
require __DIR__.'/ContainerWUrmpia/getRegistrationFormTypeService.php';
require __DIR__.'/ContainerWUrmpia/getEasyAdminSubscriberService.php';
require __DIR__.'/ContainerWUrmpia/getSecurityControllerService.php';
require __DIR__.'/ContainerWUrmpia/getRegistrationControllerService.php';
require __DIR__.'/ContainerWUrmpia/getInformationsControllerService.php';
require __DIR__.'/ContainerWUrmpia/getHomeControllerService.php';
require __DIR__.'/ContainerWUrmpia/getUserCrudControllerService.php';
require __DIR__.'/ContainerWUrmpia/getTagCrudControllerService.php';
require __DIR__.'/ContainerWUrmpia/getSubCategoryCrudControllerService.php';
require __DIR__.'/ContainerWUrmpia/getStockCrudControllerService.php';
require __DIR__.'/ContainerWUrmpia/getSizeCrudControllerService.php';
require __DIR__.'/ContainerWUrmpia/getProductCrudControllerService.php';
require __DIR__.'/ContainerWUrmpia/getPictureCrudControllerService.php';
require __DIR__.'/ContainerWUrmpia/getMarqueCrudControllerService.php';
require __DIR__.'/ContainerWUrmpia/getDashboardControllerService.php';
require __DIR__.'/ContainerWUrmpia/getCategoryCrudControllerService.php';
require __DIR__.'/ContainerWUrmpia/get_Session_DeprecatedService.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_Tbo4JjvService.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_RAlqQ78Service.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_Q6hAO0Service.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_PwZ6MTMService.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_OpmhHvService.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_L2QwsaZService.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_ZOQ9v2dService.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_W9y3dzmService.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_UDgw6OlService.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_U4BbnsnService.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_TiduPEYService.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_Nt_OgDbService.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_KfwZsneService.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_KfbR3DYService.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_CKlWSjaService.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_AWPr3oyService.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_4C0Bh8jService.php';
require __DIR__.'/ContainerWUrmpia/get_ServiceLocator_2dc0eaXService.php';
require __DIR__.'/ContainerWUrmpia/get_Container_Private_SerializerService.php';
require __DIR__.'/ContainerWUrmpia/get_Container_Private_Form_Type_FileService.php';
require __DIR__.'/ContainerWUrmpia/get_Container_Private_Form_FactoryService.php';
require __DIR__.'/ContainerWUrmpia/get_Container_Private_FilesystemService.php';
require __DIR__.'/ContainerWUrmpia/get_Container_Private_CacheClearerService.php';
...
$classes[] = 'App\Repository\ProductDetailsRepository';
